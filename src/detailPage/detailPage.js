  ...
  return (
    <div className="detail-wrap">
      <ul className='game-box'>
        <li>
          <h1 className="detail-title">SRP GAME</h1>
        </li>

        {/* 초기화 버튼 */}
        <li>
          <Button onClick={handleClearClick}>
            <img className='reset-img' src={resetIcon} alt="초기화 버튼" />
          </Button>
        </li>
        ...
        <li className='Box-inner'>
          ...
          {/* 배점 1부터 최대 9까지 가능 */}
          <div className='bet'>
            <h2 className='hidden'>배점 1부터 9까지 올릴 수 있습니다</h2>
            <span>배점</span>
            <label className="hidden" htmlFor="number">배점</label>
            <input id="number" type="number" value={bet} min={1} max={9} onChange={handleBetChange} role="button" />
            <span>배</span>
          </div>
